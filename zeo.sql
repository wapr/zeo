...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-05-2018 a las 21:23:11
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Consultorios` ()  BEGIN
	SELECT c.idConsultorio, c.nombre, c.pais, d.departamento, m.municipio, c.domicilio
    FROM consultorio c
...
(5, 1, 1, 6, '2018-04-30', '07:00:30', '10:30:00');
