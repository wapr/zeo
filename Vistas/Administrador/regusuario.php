...
if (isset($_POST['btnguardarmedico'])) {
    ...
    if ($_POST['txtclavemedico'] != $_POST['txtconfirmarclavemedico']) {
        echo '<script type="text/javascript">alert("La contraseña no es valida, vuelva a intentarlo");</script>';
        echo '<script type="text/javascript">window.location.replace("LayoutAdministrador.php?load=regusuario");</script>';
    }else {
        ...
        <div class="ui segments">
            ...
            <div class="ui secondary segment">
                <form class="ui form" method="POST">                       
                    <input type="hidden" name="txtreligionmedico" placeholder="Religión" required="true" size="35">
