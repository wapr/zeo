$(function(){   
    $("#calendar").fullCalendar({
      ...
      defaultDate: horaActual(),
        ...
        events: {
             ...
             cache: false,
             data: {
               listaActividadesMedicamentos: ""
             },
             url: myApp.url + 'PacientesControlador.php',
    ...
    $('#tblCitasRealizadas tbody').on( 'click', 'button.btnVerMedicamentos', function () {
        var data = citasRealizadas.row( $(this).parents('tr') ).data();
        $("._verMedicamentos").modal("show");
        var verMedicamentosPaciente = $('#tblVerMedicamentosPaciente').DataTable({
            "destroy":true,
            "ajax": 'http://localhost/zeo/Controladores/PacientesControlador.php?listarMedicamentos=listar&idCita='+data[6],
            "language": idioma_espanol,
            "aaSorting": [[0, "desc"]],
            "lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "todos"]],
        });       
